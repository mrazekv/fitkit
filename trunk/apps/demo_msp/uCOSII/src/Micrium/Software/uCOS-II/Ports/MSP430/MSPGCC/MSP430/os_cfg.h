/*
* Zmeny v ramci projektu do predmetu IMP
...
*         
* Uprava OS_TASK_STAT_EN v zavislosti na FITKIT_VERSION.
*/
/*
 * Zmeny nastaveni v ramci projektu ROS
 * Jiri Novotnak (xnovot87) a Tomas Novotny (xnovot88)
 */
/*
*********************************************************************************************************
*                                                uC/OS-II
...
#define OS_MAX_TASKS              4    /* Max. number of tasks in your application, MUST be >= 2       */

#define OS_SCHED_LOCK_EN          1    /* Include code for OSSchedLock() and OSSchedUnlock()           */

#define OS_TICK_STEP_EN           1    /* Enable tick stepping feature for uC/OS-View                  */
#define OS_TICKS_PER_SEC        225    /* Set the number of ticks in one second                        */


                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    170    /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   170    /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   170    /* Idle       task stack size (# of OS_STK wide entries)        */
