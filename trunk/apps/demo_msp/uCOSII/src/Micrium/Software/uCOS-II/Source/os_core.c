/*
* Uprava kodu v ramci projektu do predmetu IMP
...
* 
* Pridan include hlavickoveho souboru os_cpu_a.h pro zabraneni
* warningu pri prekladu v systemu QDevKit.
*/
/*
*********************************************************************************************************
*                                                uC/OS-II
